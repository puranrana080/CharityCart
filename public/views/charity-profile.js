...
form.addEventListener('submit', async (event) => {
    ...
    try {
        ...
        const response = await axios.post(`http://localhost:3000/charity/${charityId}/donate`, { amount }, { headers: { "Authorization": token } })
        ...
        var options = {
            ...
            "handler": async function (response) {
                await axios.post('http://localhost:3000/charity/donate/updateDonationStatus',
                    {
